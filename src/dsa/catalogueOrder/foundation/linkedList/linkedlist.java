...
public class linkedlist {
    ...
    public void removeDuplicates() {
        ...
        temp.next = null; // if there are duplicate nodes at the end then we want to set the last effective node to be null;
    }

    public void oddEven(){
        // make dummy nodes
        Node ehead = new Node();
        Node temp1 = ehead; // even list iterator
        Node ohead = new Node();
        Node temp2 = ohead; // odd head iterator
