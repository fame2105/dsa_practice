...
public class Driver {
    public static void main(String[] args) {
        SongComponent industrialMusic = new SongGroup("Industrial Music", "is a style of experimental music that draws on transgressive and provocative themes");
        ...
        everySong.add(new Song("SUfi", "Sufi Band", 2018));

        DiscJockey crazyDJ = new DiscJockey(everySong);
        crazyDJ.getSongList();
    }
}
